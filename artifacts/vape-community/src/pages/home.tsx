          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/shop/categories">
                <Button size="lg" className="h-12 px-8 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-mono text-sm uppercase tracking-wider shadow-[0_0_20px_hsl(var(--primary)/0.4)] hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)]">
                  Shop categories
                </Button>
              </Link>
